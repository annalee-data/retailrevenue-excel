...
## 6. Access
Due to the Scenario Manager feature, the [Excel file] cannot open on Excel website. In order to interact with the Excel file, you must download the raw file and open through the Microsoft Excel app.
